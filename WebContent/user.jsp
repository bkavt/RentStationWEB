...
<div class="col-1-3 brd">Price</div>
	...
	<div class="row clearfix ">
		<div class="col-1-3 brd"><c:out value="${list_eq.indexOf(i)}" /></div>
		<div class="col-1-3 brd"><c:out value="${i.getName()}" /></div>
		<div class="col-1-3 brd"><c:out value="${i.getPrice()}" /></div>
